   ...
   /* if (R.type == "VML") {
            ...
            if (R.is(arguments[0], "string") || R.is(arguments[0], "object")) {
                ...
                if (container.tagName) {
                    ...
                    if (arguments[1] == null) {
                        ...
                        //PP return {container: container, width: arguments[1], height: arguments[2]};

                        return {container: container, width: arguments[1], height: arguments[2], x: arguments[3], y: arguments[4]};
    ...
    if (R.vml) {
        ...
        var thePath = function (pathString, VML) {
            ...
            //PP g.style.cssText = "position:absolute;left:0;top:0;width:" + VML.width + "px;height:" + VML.height + "px";
		...
		*/
        ...
        var create = function () {
            ...
            var res = new Paper,
                ...
                //PP c = res.canvas = doc.createElement("div"),

				//PP canvas is set later
			...
			//PP created vb, group element for viewBox support
            ...
            vb.style.cssText = R.format("position:absolute;left:0;top:0;width:{0}px;height:{1}px", width, height);

			

			//PP changed values, added x &y
            ...
            //PP cs.cssText = R.format("width:{0};height:{1};position:absolute;clip:rect(0 {0} {1} 0);overflow:hidden", width, height);

            cs.cssText = R.format("width:{0};height:{1};position:absolute;", width, height);



			//PP add group element to container

            c[appendChild](vb);

			//set canvas point to it
        ...
        Paper[proto].clear = function () {
			...
			//PP just empty the span element

			his.span.innerHTML = E;



            //PP this.span = doc.createElement("span");

            this.span.style.cssText = "position:absolute;left:-9999em;top:-9999em;padding:0;margin:0;line-height:1;display:inline;";

            //PP this.canvas[appendChild](this.span);
    ...
    //PP Paper[proto].setSize = setSize;

	//PP added setView

    Paper[proto].setView = setView;
